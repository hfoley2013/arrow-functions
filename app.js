...
// sum Refactor
const reSum = (a, b, c, d) => a + b + c + d;
console.log('reSum:', reSum(1,2,3,4));
...
// objectLit Refactor
const reObjectLit = objArray => ({
  key1: 'value1',
  key2: 'value2',
  key3: 'value3',
});
console.log('reObjectLit', reObjectLit());
...
//sumAndProduct Refactor
const reSumAndProduct = (a, b) => {
  let sum = a + b;
  let product = a * b;
  return [sum, product];
} 
console.log('reSumAndProduct:', reSumAndProduct(3, 9));
...
// message Refactor
const reMessage = name => `Hello, ${name}!`;
console.log('reMessage:', reMessage('Allie'));
...
// const reStudent = (name, age, hometown) => ({
//   this.name = name;
//   this.age = age;
//   this.hometown = hometown;
// })

// let reJoe = reStudent('Joe Schmoe', 100, 'Anytown, USA');
// console.log('reJoe:', reJoe);
...
//    The "this" of joe.scope() is the Student object created via our constructor, Student
// 2. What is "this" when joe.scopeArrow() is invoked?
//    The "this" of joe.scopeArrow() is the global window object
// 3. Explain why "this" is different when an arrow function is used.
//    When an arrow function is used with "this", it retains the "this" value of the enclosing functional scope, which in the case of arrow functions is the global scope. The "this" value used in constructors is local in scope, but accessible globally by functions sharing the same prototypes. However, because arrow functions retain the "this" value of the global scope, you cannot access the "this" value of a given prototype.
